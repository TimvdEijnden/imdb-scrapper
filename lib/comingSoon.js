...
/**
 * getComingSoon - the function provide movies coming soon
 *
 * @param {number} [n=10]       number of result
 *
 * @returns {Promise<Array>} array with result
 */
function getComingSoon(n = 10) {
  const url = 'https://www.imdb.com/movies-coming-soon/';
  return request(url)
    .then(data => {
